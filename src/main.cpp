...
constexpr bool THROTTLE_1_CRITICALITY = false;
constexpr uint8_t THROTTLE_1_PIN = 18;

constexpr bool THROTTLE_2_CRITICALITY = false;
...
constexpr bool BRAKE_CRITICALITY = false;
...
constexpr bool SWITCH_CRITICALITY = false;
